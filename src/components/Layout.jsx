...
import { LayoutDashboard, BookOpen, Target, BarChart3, LogOut, Menu, X } from 'lucide-react'
...
export default function Layout() {
  ...
  const NavContent = () => (
    <>
      ...
      >
        <Logo />
        <p className="text-[11px] text-slate-soft leading-tight truncate max-w-[180px] mt-1 ml-[38px]">{user?.email}</p>
      </button>
